...
program CFC11
  ...
  do bnd_idx=1,bnd_nbr
     abs_cff_mss(bnd_idx)=abs_xsx(bnd_idx)*Avagadro/mmw_CFC11
  ...
  rcd=nf90_wrp(nf90_put_att(nc_id,abs_xsx_cold_id,'long_name','CFC11 absorption cross section at tpt_cold'),sbr_nm)
  rcd=nf90_wrp(nf90_put_att(nc_id,abs_xsx_dadT_id,'long_name','Absorption cross section temperature-dependence'),sbr_nm)
  rcd=nf90_wrp(nf90_put_att(nc_id,abs_xsx_id,'long_name','CFC11 absorption cross section at tpt_rfr'),sbr_nm)
  rcd=nf90_wrp(nf90_put_att(nc_id,abs_xsx_tpt_rfr_id,'long_name','Valid temperature for absorption cross section'),sbr_nm)
  rcd=nf90_wrp(nf90_put_att(nc_id,abs_xsx_warm_id,'long_name','CFC11 absorption cross section at tpt_warm'),sbr_nm)

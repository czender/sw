...
110 continue
  ...
  !$omp parallel private(dtauc,ssalb,pmom,wvnmlo)
  !$omp parallel private(wvnmhi,utau)
  !$omp parallel private(fbeam)
  !$omp parallel private(albedo)
  !$omp parallel private(plank,header)
  !$omp parallel private(rfldir,rfldn)
  !$omp parallel private(flup,dfdt,uavg,uu,albmed,trnmed,u0u)
  !$omp parallel private(bnd_idx,lev_idx,bnd_idx_O3,bnd_idx_CO)
  !$omp parallel private(bnd_idx_N2O,bnd_idx_N2,bnd_idx_CH4,bnd_idx_H2O,bnd_idx_CO2,i21)
  !$omp parallel private(mmn_idx,tau_idx,plr_idx,azi_idx)
  !$omp parallel private(phi_wgt,psi_wgt,u_bar,prs_bar,float_foo,tau)
  !$omp parallel private(opt_dep_ITOD_H2O,opt_dep_ITOD_O2,opt_dep_ITOD_OH)
  !$omp parallel private(opt_dep_ITOD_CH4,opt_dep_ITOD_CO,opt_dep_ITOD_N2,opt_dep_ITOD_N2O,opt_dep_ITOD_O3)
  !$omp parallel private(opt_dep_ITOD_CO2_hires,opt_dep_LTOD_CO2_hires,trn_LT_CO2_hires,trn_ALT_CO2)
  !$omp parallel private(odsl_Ray,odsl_ice,odsl_lqd,odsl_aer,odsl_bga,odal_ice,odal_lqd,odal_aer,odal_bga)
  !$omp parallel private(odal_OH,odal_CO,odal_N2,odal_N2O,odal_CH4)
  !$omp parallel private(odal_O2,odal_O3,odal_O2O2,odal_O2N2,odal_NO2,odal_CFC11,odal_CFC12,odal_CO2,odal_H2OH2O,odal_H2O)
  !$omp parallel private(sca_cff_mss_Ray,sca_frc_HG,sca_frc_Mie)
  !$omp parallel shared(nlyr,nmom,temper)
  !$omp parallel shared(usrtau,ntau,nstr,usrang,numu)
  !$omp parallel shared(umu,nphi,phi,ibcnd,umu0,phi0)
  !$omp parallel shared(fisot,lamber,btemp,bemis,ttemp,temis)
  !$omp parallel shared(onlyfl,accur,prnt)
  !$omp parallel shared(dbg_lvl,thr_nbr,brdf_typ)
  !$omp parallel shared(idx_rfr_air_STP,prg_nm,sv_ntn,sv_cmp_tau,single_bnd_computation)
  !$omp parallel shared(hb,br,f_iso,f_vol,f_geo,nrm_cff_CM,idx_rfr_sfc,b0,hh,w,nrm_rfl_M,k_cff_M,nrm_cff_RP,k_cff_RP,g_phs)
  !$omp parallel shared(nrm_rfl_LS,wvl_ctr,wvl_dlt,wvl_min,wvl_max,wvn_min,wvn_max,bnd_dbg,tst_case_Rayleigh,tst_case_HG)
  !$omp parallel shared(flg_Rayleigh,flg_ice,flg_lqd,flg_aer,flg_bga,flg_H2O,flg_H2OH2O,flg_OH,flg_CH4,flg_CO,flg_N2)
  !$omp parallel shared(flg_N2O,flg_O2,flg_CO2,flg_O3,flg_HHCWC,flg_O2O2,flg_O2N2,flg_NO2,flg_CFC11,flg_CFC12)
  !$omp parallel shared(bnd_obs_aer,bnd_obs_bga,flg_Planck,wvl_Planck,mode_chn)
  !$omp parallel shared(prs,prs_ntf,tpt,mmw_mst_air,mpl_mst_air,grv,pi,ocn_msk)
  !$omp parallel shared(odal_obs_aer,odsl_obs_aer,odxl_obs_aer,odal_obs_bga,odsl_obs_bga,odxl_obs_bga)
  !$omp parallel shared(slr_zen_ngl_cos,alb_sfc_vsb_drc,alb_sfc_vsb_dff,alb_sfc_NIR_drc,alb_sfc_NIR_dff)
  !$omp parallel shared(slr_cst_xnt_fac,flx_slr_frc,chn_SRF_msk)
  !$omp parallel shared(lev_nbr,levp_nbr,plr_nbr,mmn_nbr,azi_nbr,tau_nbr)
  !$omp parallel shared(bnd_nbr_H2O,bnd_nbr_pure_HHCWC,bnd_nbr_non_HHCWC,bnd_nbr_HC,bnd_nbr_HHCWC)
  !$omp parallel shared(abs_xsx_O3,abs_xsx_O3_dadT,tpt_std_O3,npl_O3)
  !$omp parallel shared(wvl_min_HHCWC,wvl_max_HHCWC,abs_xsx_O2,npl_O2,bnd_nbr,abs_xsx_H2OH2O,npl_H2OH2O)
  !$omp parallel shared(abs_xsx_O2O2,npl_O2O2,abs_xsx_NO2,npl_NO2,abs_xsx_CFC11,npl_CFC11,abs_xsx_CFC12,npl_CFC12)
  !$omp parallel shared(abs_cff_mss_lqd,mpl_LWP,sca_cff_mss_lqd,bnd_nbr_lqd,wvl_min_lqd,wvl_max_lqd,asm_prm_lqd)
  !$omp parallel shared(abs_cff_mss_aer,mpl_aer,sca_cff_mss_aer,bnd_nbr_aer,wvl_min_aer,wvl_max_aer,asm_prm_aer)
  !$omp parallel shared(abs_cff_mss_bga,mpl_bga,sca_cff_mss_bga,bnd_nbr_bga,wvl_min_bga,wvl_max_bga,asm_prm_bga)
  !$omp parallel shared(abs_cff_mss_ice,mpl_IWP,sca_cff_mss_ice,bnd_nbr_ice,wvl_min_ice,wvl_max_ice,asm_prm_ice)
  !$omp parallel shared(lgn_xpn_cff_Mie_ttl,asm_prm_HG_ttl,asm_prm_lqd,asm_prm_ice,asm_prm_aer,asm_prm_bga)
  !$omp parallel shared(flx_spc_dwn,flx_spc_dwn_dff,flx_spc_dwn_drc,flx_spc_net,flx_spc_upw)
  !$omp parallel shared(ntn_bb_aa,ntn_spc_aa_ndr,ntn_spc_aa_ndr_TOA,ntn_spc_aa_ndr_sfc,ntn_spc_TOA)
  !$omp parallel shared(ntn_spc_aa_sfc,ntn_spc_aa_zen,ntn_spc_aa_zen_sfc,ntn_spc_chn,ntn_spc_mean)
  !$omp parallel shared(odac_spc_aer,odac_spc_snw,odac_spc_mpr,odac_spc_bga,odac_spc_ice,odac_spc_lqd,odal_spc_ttl)
  !$omp parallel shared(odsl_spc_ttl,odxc_spc_CO2,odxc_spc_H2O,odxc_spc_H2OH2O,odxc_spc_NO2,odxc_spc_CFC11,odxc_spc_CFC12)
  !$omp parallel shared(odxc_spc_O2,odxc_spc_O2N2,odxc_spc_O2O2,odxc_spc_O3,odxc_spc_OH,odxc_spc_CH4,odxc_spc_CO,odxc_spc_N2)
  !$omp parallel shared(odxc_spc_N2O,odxc_spc_Ray,odxc_spc_aer,odxc_spc_aer,odxc_spc_bga,odxc_spc_ice,odxc_spc_lqd)
  !$omp parallel shared(odxl_spc_ttl,odxc_spc_ttl)
  !$omp parallel shared(S_d_abs_cff_mss_H2O,S_p_abs_cff_mss_H2O,mpl_H2O,A_phi_H2O,B_phi_H2O,A_psi_H2O,B_psi_H2O,q_H2O)
  !$omp parallel shared(S_d_abs_cff_mss_OH,S_p_abs_cff_mss_OH,mpl_OH,A_phi_OH,B_phi_OH,A_psi_OH,B_psi_OH,q_OH)
  !$omp parallel shared(S_d_abs_cff_mss_CH4,S_p_abs_cff_mss_CH4,mpl_CH4,A_phi_CH4,B_phi_CH4,A_psi_CH4,B_psi_CH4,q_CH4)
  !$omp parallel shared(S_d_abs_cff_mss_CO,S_p_abs_cff_mss_CO,mpl_CO,A_phi_CO,B_phi_CO,A_psi_CO,B_psi_CO,q_CO)
  !$omp parallel shared(S_d_abs_cff_mss_N2,S_p_abs_cff_mss_N2,mpl_N2,A_phi_N2,B_phi_N2,A_psi_N2,B_psi_N2,q_N2)
  !$omp parallel shared(S_d_abs_cff_mss_N2O,S_p_abs_cff_mss_N2O,mpl_N2O,A_phi_N2O,B_phi_N2O,A_psi_N2O,B_psi_N2O,q_N2O)
  !$omp parallel shared(S_d_abs_cff_mss_O2,S_p_abs_cff_mss_O2,mpl_O2,A_phi_O2,B_phi_O2,A_psi_O2,B_psi_O2,q_O2)
  !$omp parallel shared(S_d_abs_cff_mss_O3,S_p_abs_cff_mss_O3,mpl_O3,A_phi_O3,B_phi_O3,A_psi_O3,B_psi_O3,q_O3)
  !$omp parallel shared(S_d_abs_cff_mss_CO2,S_p_abs_cff_mss_CO2,mpl_CO2,A_phi_CO2,B_phi_CO2,A_psi_CO2,B_psi_CO2,q_CO2)
  !$omp parallel shared(ss_alb_fct,tpt_dlt_Mlk,tpt_dlt_Mlk_sqr,tpt_dlt_O3)
#ifdef _OPENMP
  !$omp single
  ...
  do bnd_idx=1,bnd_nbr
     ...
     do lev_idx=1,lev_nbr
        if (ss_alb_fct(bnd_idx,lev_idx) > 1.0) then
           write (6,'(a,a,i4,a,i3,a,f10.7,a,i3,a,f10.3,a,i4,a,f10.7,a,e11.4,a20,e11.4)') &

...
\includegraphics*[width=.5\hsize]{/data/zender/ps/nflux18_8589_01_SWCF.eps}%
\includegraphics*[width=.5\hsize]{/data/zender/ps/nflux18_8589_07_SWCF.eps}%
...
\includegraphics*[width=.5\hsize]{/data/zender/ps/nflux18_8589_01_LWCF.eps}%
\includegraphics*[width=.5\hsize]{/data/zender/ps/nflux18_8589_07_LWCF.eps}%
...
\begin{figure}
\begin{center}
\includegraphics*[width=\halfwidth]{/data/zender/ps/erbe_b_nflux18_amip5_sld012d_xavg_8589_01_LWCF.eps}\vfill
\includegraphics*[width=\halfwidth]{/data/zender/ps/erbe_b_nflux18_amip5_sld012d_xavg_8589_07_LWCF.eps}\vfill
\end{center}
...
\begin{figure}
\begin{center}
\includegraphics*[width=\halfwidth]{/data/zender/ps/erbe_b_nflux18_amip5_sld012d_xavg_8589_01_SWCF.eps}\vfill
\includegraphics*[width=\halfwidth]{/data/zender/ps/erbe_b_nflux18_amip5_sld012d_xavg_8589_07_SWCF.eps}\vfill
\end{center}
...
\includegraphics*[width=\halfwidth]{/data/zender/ps/nflux18_anom_xavg_8589_0112_SWCF.eps}\vfill
...
\includegraphics*[width=\halfwidth]{/data/zender/ps/nflux18_anom_xavg_8589_0112_LWCF.eps}\vfill
...
\includegraphics*[width=.5\textwidth,height=.45\textheight]{/data/zender/ps/nflux18_anom_yavg_10S10N_8589_0160_SWCF.eps}%
...
\includegraphics*[width=.5\textwidth,height=.45\textheight]{/data/zender/ps/nflux18_anom_yavg_10S10N_8589_0160_LWCF.eps}%
...
\includegraphics*[width=.5\textwidth,height=.45\textheight]{/data/zender/ps/nflux18_yavg_10S10N_8589_0160_SWCF.eps}%
...
\includegraphics*[width=.5\textwidth,height=.45\textheight]{/data/zender/ps/nflux18_yavg_10S10N_8589_0160_LWCF.eps}%
...
\includegraphics*[width=.5\textwidth,height=.45\textheight]{/data/zender/ps/nflux18_anom_yavg_10S10N_8589_0160_FLNT.eps}%
...
\end{center}
\caption[Hovm\"oller diagrams of outgoing longwave radiation
anomaly in the equatorial Pacific for 1985--1989 NOAA, NFLUX18,
CCM$\Omega_{.5}$, and CCM3]{ 
Hovm\"oller diagrams of outgoing longwave radiation anomaly (\wxmS) in
the equatorial Pacific (averaged 10~\degreee S--10~\degreee N) for 
1985--1989 (a) NOAA, (b) NFLUX18, (c) CCM$\Omega_{.5}$ and (d) 
CCM3.
Month 1 is January 1985.  
Contour interval is 10~\wxmS. 
\label{fig:anom_yavg_10S10N_8589_0160_FLNT}}
...
\includegraphics*[width=.5\textwidth,height=.9\textheight]{/data/zender/ps/nflux18_anom_yavg_10S10N_8589_0160_TS1.eps}%
\end{center}
\caption[Hovm\"oller diagrams of sea surface temperature (SST) and SST
anomaly in the equatorial Pacific for 1985--1989 NFLUX18]{  
...
S--10~\degreee N) for 1985--1989 NFLUX18.
Month 1 is January 1985.  
...
\begin{figure*}
\begin{center}
\includegraphics*[width=.5\textwidth,height=.9\textheight]{/data/zender/ps/nflux18_anom_yavg_10S10N_8589_0160_CLDTOT.eps}%
...
\begin{figure*}
\begin{center}
\includegraphics*[width=.5\textwidth,height=.9\textheight]{/data/zender/ps/nflux18_anom_yavg_10S10N_8589_0160_CLDHGH.eps}%
...
\begin{figure*}
\begin{center}
\includegraphics*[width=.5\textwidth,height=.9\textheight]{/data/zender/ps/nflux18_anom_yavg_10S10N_8589_0160_CLDMED.eps}%
...
\begin{figure*}
\begin{center}
\includegraphics*[width=.5\textwidth,height=.9\textheight]{/data/zender/ps/nflux18_anom_yavg_10S10N_8589_0160_CLDLOW.eps}%
...
\begin{figure*}
\begin{center}
\includegraphics*[width=.5\textwidth,height=.9\textheight]{/data/zender/ps/nflux18_anom_yavg_10S10N_8589_0160_TOTCWP.eps}%
...
the equatorial Pacific for 1985--1989 NFLUX18 and CCM3]{ 
Hovm\"oller diagrams of condensed water path anomaly (\gxmS) in the
equatorial Pacific (averaged 10~\degreee S--10~\degreee N) for
1985--1989 (a) NFLUX18 and (b) CCM3.
Month 1 is January 1985.  
...
\begin{figure*}
\begin{center}
\includegraphics*[width=.5\textwidth,height=.9\textheight]{/data/zender/ps/nflux18_yavg_10S10N_8589_0160_CLDTOT.eps}%
...
\begin{figure*}
\begin{center}
\includegraphics*[width=.5\textwidth,height=.9\textheight]{/data/zender/ps/nflux18_yavg_10S10N_8589_0160_CLDHGH.eps}%
...
\begin{figure*}
\begin{center}
\includegraphics*[width=.5\textwidth,height=.9\textheight]{/data/zender/ps/nflux18_yavg_10S10N_8589_0160_CLDMED.eps}%
...
\begin{figure*}
\begin{center}
\includegraphics*[width=.5\textwidth,height=.9\textheight]{/data/zender/ps/nflux18_yavg_10S10N_8589_0160_CLDLOW.eps}%
...
\begin{figure*}
\begin{center}
\includegraphics*[width=.5\textwidth,height=.9\textheight]{/data/zender/ps/nflux18_yavg_10S10N_8589_0160_TOTCWP.eps}%
...
\includegraphics*[width=.25\textheight]{/data/zender/ps/nflux18_reg_Pacific_Equatorial_87m85_0305_LWCF_SWCF.eps}%
...
\includegraphics*[width=.25\textheight]{/data/zender/ps/nflux18_reg_Pacific_Equatorial_87m85_0305_TS1_LWCF.eps}%
...
\includegraphics*[width=.25\textheight]{/data/zender/ps/nflux18_reg_Pacific_Equatorial_87m85_0305_TS1_SWCF.eps}%
...
\includegraphics*[width=.25\hsize]{/data/zender/ps/nflux18_reg_Pacific_Equatorial_87m85_0305_LWCF_SWCF.eps}%
...
\includegraphics*[width=.25\hsize]{/data/zender/ps/nflux18_reg_Pacific_Equatorial_87m85_0305_TS1_LWCF.eps}%
...
\includegraphics*[width=.25\hsize]{/data/zender/ps/nflux18_reg_Pacific_Equatorial_87m85_0305_TS1_SWCF.eps}%

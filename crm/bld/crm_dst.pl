...
# Usage:
# $HOME/crm/crm/bld/crm_dst.pl ccm3_6_brnchT_crm2_1_5
# $HOME/crm/crm/bld/crm_dst.pl --dbg=1 ccm_brnch_crm 
# $HOME/crm/crm/bld/crm_dst.pl --dbg=2 --cln ccm_brnch_crm 
# $HOME/crm/crm/bld/crm_dst.pl --dbg=1 --cln --dst_cln ccm3_6_brnchT_crm2_1_5
...
my $data_nm=$ENV{'DATA'};
my $ftp_drc='/home/ftp/pub/zender/crm'; # Directory on FTP machine where repository resides
...
my $www_drc='/var/www/html/crm'; # WWW directory for package

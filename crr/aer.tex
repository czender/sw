...
% Copyright (c) 1998--2015, Charles S. Zender
...
% cd ~/crr;make -W aer.tex aer.pdf;cd -
...
\begin{figure*}[b]
\centering
\includegraphics[width=\hsize]{/data/zender/fgr/aer/esh_fgr_cpy}\vfill
...
\includegraphics[width=0.8\hsize]{/data/zender/fgr/aer/vlc_dps_aer}\vfill
\end{center}
...
\includegraphics[width=0.8\hsize]{/data/zender/fgr/aer/psd_cll_fsh}\vfill
\end{center}
...
\begin{center}
% Figure created by mie.pro:psd_bch()
\includegraphics[width=0.8\hsize]{/data/zender/fgr/aer/psd_scv_cff}\vfill
\end{center}
...
\includegraphics[width=0.8\hsize]{/data/zender/fgr/aer/scv_gph}\vfill
\end{center}
...
cd ~/crr;make -W aer.tex aer.dvi aer.ps aer.pdf aer.txt;cd -

# dvips -Ppdf -G0 -o ${DATA}/ps/aer.ps ~/crr/aer.dvi;ps2pdf ${DATA}/ps/aer.ps ${DATA}/ps/aer.pdf
# cd ~/crr;texcln aer;make aer.pdf;bibtex aer;makeindex aer;make aer.pdf;bibtex aer;makeindex aer;make aer.pdf;cd -
scp -p ~/crr/aer.tex ~/crr/aer.txt ~/crr/aer.dvi ${DATA}/ps/aer.ps ${DATA}/ps/aer.pdf dust.ess.uci.edu:/var/www/html/facts/aer

# 20030625: latex2html chokes on math in tables in \csznote{}s
# cd ~/crr;latex2html -dir /var/www/html/facts/aer aer.tex
# cd ~/crr;latex2html -nolatex -dir /var/www/html/facts/aer aer.tex
# NB: tth works well on aer.tex
# cd ~/crr;tth -a -Laer -p./:${TEXINPUTS}:${BIBINPUTS} < aer.tex > aer.html
# scp aer.html dust.ess.uci.edu:/var/www/html/facts/aer
# NB: tex4ht works poorly on aer.tex
# cd ~/crr;htlatex aer.tex # Works OK, index not linked
cd ~/crr;htlatex aer.tex;makeindex -o aer.ind aer.4dx
cd ~/crr;scp aer*.css aer*.html dust.ess.uci.edu:/var/www/html/facts/aer
# NB: tex4moz works poorly on aer.tex
cd ~/crr;/usr/share/tex4ht/mzlatex aer.tex
cd ~/crr;scp aer*.css aer*.html aer*.xml dust.ess.uci.edu:/var/www/html/facts/aer

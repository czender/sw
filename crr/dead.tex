...
% Usage: 
% dvips -Ppdf -G0 -o ${DATA}/ps/dead.ps ~/crr/dead.dvi;ps2pdf ${DATA}/ps/dead.ps ${DATA}/ps/dead.pdf
% cd ~/crr;make -W dead.tex dead.txt dead.dvi dead.ps dead.pdf;cd -
% cd ~/crr;texcln dead;make dead.pdf;bibtex dead;makeindex dead;make dead.pdf;bibtex dead;makeindex dead;make dead.pdf;cd -
% scp -p ${HOME}/crr/dead.tex ${HOME}/crr/dead.txt ${DATA}/ps/dead.ps ${DATA}/ps/dead.pdf ${HOME}/crr/dead.dvi dust.ess.uci.edu:/var/www/html/dead

% # NB: latex2html works well on dead.tex
% latex2html -dir /var/www/html/dead dead.tex
% # NB: tth chokes on dead.tex
% cd ${HOME}/crr;tth -a -Ldead -p./:${TEXINPUTS}:${BIBINPUTS} < ${HOME}/crr/dead.tex > dead.html
% scp dead.html dust.ess.uci.edu:/var/www/html/dead
% # NB: tex4ht works well on dead.tex
% cd ${HOME}/crr;htlatex dead.tex
% scp dead*.css dead*.html dust.ess.uci.edu:/var/www/html/dead
% # NB: tex4moz works well on dead.tex
% cd ${HOME}/crr;/usr/share/tex4ht/mzlatex dead.tex
% scp dead*.css dead*.html dead*.xml dust.ess.uci.edu:/var/www/html/dead

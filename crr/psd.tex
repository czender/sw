...
% cd ~/crr;make -W psd.tex psd.pdf;cd -
...
cd ~/crr;make -W psd.tex psd.dvi psd.ps psd.pdf psd.txt;cd -

# dvips -Ppdf -G0 -o ${DATA}/ps/psd.ps ~/crr/psd.dvi;ps2pdf ${DATA}/ps/psd.ps ${DATA}/ps/psd.pdf
# cd ~/crr;texcln psd;make psd.pdf;bibtex psd;makeindex psd;make psd.pdf;bibtex psd;makeindex psd;make psd.pdf;cd -
scp -p ~/crr/psd.tex ~/crr/psd.txt ~/crr/psd.dvi ${DATA}/ps/psd.ps ${DATA}/ps/psd.pdf dust.ess.uci.edu:/var/www/html/facts/psd

# NB: latex2html works well on psd.tex
# cd ~/crr;latex2html -dir /var/www/html/facts/psd psd.tex
# NB: tth works poorly on psd.tex
# cd ~/crr;tth -a -Lpsd -p./:${TEXINPUTS}:${BIBINPUTS} < psd.tex > psd.html
# scp psd.html dust.ess.uci.edu:/var/www/html/facts/psd
# NB: tex4ht works well on psd.tex
# cd ~/crr;htlatex psd.tex # Works OK, index not linked
cd ~/crr;htlatex psd.tex;makeindex -o psd.ind psd.4dx
cd ~/crr;scp psd*.css psd*.html dust.ess.uci.edu:/var/www/html/facts/psd
# NB: tex4moz works poorly on psd.tex
cd ~/crr;/usr/share/tex4ht/mzlatex psd.tex
cd ~/crr;scp psd*.css psd*.html psd*.xml dust.ess.uci.edu:/var/www/html/facts/psd

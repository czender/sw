...
% Usage: 
% dvips -Ppdf -G0 -o ${DATA}/ps/rt.ps ~/crr/rt.dvi;ps2pdf ${DATA}/ps/rt.ps ${DATA}/ps/rt.pdf
% cd ~/crr;make rt.pdf;cd -
% cd ~/crr;make rt.dvi rt.pdf rt.ps rt.txt;cd -
% cd ~/crr;texcln rt;make rt.pdf;bibtex rt;makeindex rt;make rt.pdf;bibtex rt;makeindex rt;make rt.pdf;cd -
% scp -p ${HOME}/crr/rt.tex ${HOME}/crr/rt.txt ${HOME}/crr/rt.dvi ${DATA}/ps/rt.ps ${DATA}/ps/rt.pdf dust.ess.uci.edu:/var/www/html/facts/rt
...
% cd ~/crr;latex2html -dir /var/www/html/facts/rt rt.tex
% # NB: tth works well on rt.tex
% cd ${HOME}/crr;tth -a -Lrt -p${TEXINPUTS}:${BIBINPUTS} < rt.tex > rt.html
% scp rt.html dust.ess.uci.edu:/var/www/html/facts/rt
% # NB: tex4ht works well on rt.tex
% cd ${HOME}/crr;htlatex rt.tex
% cd ${HOME}/crr;scp rt*.css rt*.html dust.ess.uci.edu:/var/www/html/facts/rt
% # NB: tex4moz works poorly on rt.tex
% cd ${HOME}/crr;/usr/share/tex4ht/mzlatex rt.tex
% cd ${HOME}/crr;scp rt*.css rt*.html rt*.xml dust.ess.uci.edu:/var/www/html/facts/rt
...
\bigskip\noindent
Copyright \copyright\ 1998--2014, Charles S. Zender\\
Permission is granted to copy, distribute and/or modify this document
...
\begin{figure*}
\centering
\includegraphics[width=0.8\hsize]{/data/zender/fgr/rt/j_NO2_act_flx}\vfill
\includegraphics[width=0.8\hsize]{/data/zender/fgr/rt/j_NO2_abs_xsx}\vfill
\includegraphics[width=0.8\hsize]{/data/zender/fgr/rt/j_NO2_qnt_yld}\vfill
...
\begin{figure*}
\centering
\includegraphics[width=0.8\hsize]{/data/zender/fgr/rt/j_NO2_arese_19951011}\vfill
\includegraphics[width=0.8\hsize]{/data/zender/fgr/rt/j_NO2_rlt_arese_19951011}\vfill
...
However these forms are not recommended for computational
implementation because the positive exponentials are difficult to
handle for large optical depths.
Moreover, the difference between the exponential terms will quickly
lead to a loss of numerical precision as $\tau \rightarrow \infty$.
...
Pressure- and Doppler-broadening effects dominated line shapes here.
...
Collisions which do alter the kinetic energy of one or both of the 
...
molecules.  
Collisions which alter the rotational or vibrational quanta of one or
...
per second. 
In practice in the lower atmosphere $\hwhmprs >> \hwhmntr$ so the
...
We shall attempt to determine an \trmdfn{scaled absorber path}
...
30\%.
Thus the usualy practice, which is often adeequate, is to set
...
Consider an the absorption optical depth through an arbitrary
...
(\ref{eqn:phi_scl_dpp}) depends most exponentially on 
...
\acr{hitran}-standard temperature (296\,K) to 250\,K, which is near
...
\mpi \rds^{2} \fshabs(\rds,\wvl) \dstnbr(\rds,\hgt) \,\dfr\rds}
{\int_{0}^{\infty}
\frac{4\mpi}{3} \rds^{3} \dstnbr(\rds,\hgt) \,\dfr\rds} \\
...
\begin{figure*}
\centering
\includegraphics[height=0.3\vsize]{/data/zender/fgr/rt/erbe_b_8589_SOLIN}\vfill
\includegraphics[height=0.3\vsize]{/data/zender/fgr/rt/erbe_b_8589_FSUT}\vfill
\includegraphics[height=0.3\vsize]{/data/zender/fgr/rt/erbe_b_8589_FSNT}\vfill
...
\begin{figure*}
\centering
\includegraphics[height=0.3\vsize]{/data/zender/fgr/rt/erbe_b_8589_FLUS}\vfill
\includegraphics[height=0.3\vsize]{/data/zender/fgr/rt/erbe_b_8589_GCLD}\vfill
\includegraphics[height=0.3\vsize]{/data/zender/fgr/rt/erbe_b_8589_FLNT}\vfill
...
\begin{figure*}
\centering
\includegraphics[width=0.5\hsize,height=0.9\vsize]{/data/zender/fgr/rt/sld012d_yavg_10S10N_8589_0160_TS1}%
\includegraphics[width=0.5\hsize,height=0.9\vsize]{/data/zender/fgr/rt/erbe_b_yavg_10S10N_8589_0160_FLNT}
...
\begin{figure*}
\centering
\includegraphics[width=0.8\hsize]{/data/zender/fgr/rt/erbe_b_8589_01_SWCF}\vfill
\includegraphics[width=0.8\hsize]{/data/zender/fgr/rt/erbe_b_8589_07_SWCF}%
...
\begin{figure*}
\centering
\includegraphics*[width=0.8\hsize]{/data/zender/fgr/rt/erbe_b_sld012d_8589_01_x_SWCF}\vfill
\includegraphics*[width=0.8\hsize]{/data/zender/fgr/rt/erbe_b_sld012d_8589_07_x_SWCF}%
...
\begin{figure*}
\centering
\includegraphics[width=0.8\hsize]{/data/zender/fgr/rt/erbe_b_8589_01_LWCF}\vfill
\includegraphics[width=0.8\hsize]{/data/zender/fgr/rt/erbe_b_8589_07_LWCF}%
...
\begin{figure*}
\centering
\includegraphics*[width=0.8\hsize]{/data/zender/fgr/rt/erbe_b_sld012d_8589_01_x_LWCF}\vfill
\includegraphics*[width=0.8\hsize]{/data/zender/fgr/rt/erbe_b_sld012d_8589_07_x_LWCF}%
...
\begin{figure*}
\centering
\includegraphics[height=0.3\vsize]{/data/zender/fgr/rt/erbe_b_8589_SWCF}\vfill
\includegraphics[height=0.3\vsize]{/data/zender/fgr/rt/erbe_b_8589_LWCF}\vfill
\includegraphics[height=0.3\vsize]{/data/zender/fgr/rt/erbe_b_8589_NCF}\vfill
...
\begin{figure*}
\centering
\includegraphics[width=0.5\hsize,height=0.9\vsize]{/data/zender/fgr/rt/erbe_b_yavg_10S10N_8589_0160_LWCF}%
\includegraphics[width=0.5\hsize,height=0.9\vsize]{/data/zender/fgr/rt/erbe_b_yavg_10S10N_8589_0160_SWCF}

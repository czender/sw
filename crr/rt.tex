...
Setting the first term $\aaa = 1$ in (\ref{eqn:geo_srs}) and the constant ratio~$\rrr$ between terms to $\rrr = \yyy = \me^{-\xxx}$ yields $(1-\me^{-\xxx})^{-1}$ which is the starting point and the correct sum of (\ref{eqn:tyl_mcl_srs}).
...
Mercifully, each term of (\ref{eqn:tyl_mcl_new}) amenable to integration by parts.
This technique re-expresses integrals of the form $\int \uuu\,\dfr\vvv$ by the equivalent form $\uuu\vvv - \int \vvv\,\dfr\uuu$.
The first term of (\ref{eqn:tyl_mcl_new}) can be expressed in this form by defining the change of variables $\uuu = \xxx^{3}$, $\dfr\vvv = \me^{-\xxx}$ so that $\dfr\uuu = 3\xxx^{2}$, $\vvv = -\me^{-\xxx}$.
Integrating by parts we obtain
\begin{eqnarray}
\int_{\xxxone}^{\infty} \xxx^{3}\me^{-\kkk\xxx} \,\dfr\xxx  
& = &
\int_{\xxxone}^{\infty} \uuu\,\dfr\vvv \quad = \quad
\uuu\vvv \bigg|_{\xxxone}^{\infty} - \int_{\xxxone}^{\infty} \vvv\,\dfr\uuu \nonumber \\
& = &
-\xxx^{3}\me^{-\xxx}\bigg|_{\xxxone}^{\infty} + 
\int_{\xxxone}^{\infty} 3\xxx^{2}\me^{-\xxx} \,\dfr\xxx \nonumber \\
& = &
-\xxx^{3}\me^{-\xxx}\bigg|_{\xxxone}^{\infty} + 
3 \left( \int_{\xxxone}^{\infty} 3\xxx^{2}\me^{-\xxx} \,\dfr\xxx \right)

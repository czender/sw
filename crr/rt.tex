...
to $\xxx$:
% fxm: convert this to wavenumbers
\begin{eqnarray}
...
\end{align}
\end{subequations}
$\rdncstone$ is outside the definite integral and is identical for all
forms of the independent variable for frequency. 
$\rdncsttwo$ is inside the definite integral, and depends on the units 
of the independent variable.

We can expand the integrand of (\ref{eqn:rdn_cst_dfn}) into an
...
\end{eqnarray}
We can rewrite the integrand of (\ref{eqn:rdn_cst_dfn}) as an
infinite series by using the Taylor-Maclaurin expansion of
$(\me^{\xxx}-1)^{-1}$.
Using the substitution $\yyy = \me^{\xxx}$, we find the Maclaurin
series by adding successive derivatives of the equivalent
function $(\yyy-1)^{-1}$  evaluated at $\yyy = 0$, normalized by the 
factorial of the term:
\begin{eqnarray}
  (\me^{\xxx}-1)^{-1} & \equiv & (\yyy-1)^{-1} \nonumber \\
  & \equiv & \left. \sum_{\kkk=0}^{\kkk=\infty}
  \frac{\dfr^{\kkk}}{\dfr \yyy^{\kkk}} (\yyy - 1)^{-1} \right|_{\yyy=0}
  \cdot \frac{\yyy^{\kkk}}{\kkk!} \nonumber \\
  & = & 
  (\yyy - 1)^{-1} \bigg|_{\yyy=0} \cdot \frac{\yyy^{0}}{0!} + 
  (-1)(\yyy - 1)^{-2}(1) \bigg|_{\yyy=0} \cdot \frac{\yyy^{1}}{1!} + \nonumber \\
  & & 
  % {} so ``+'' gets binary not unary operator spacing KoD95 p. 136
  {} (-1)(-2)(\yyy - 1)^{-3}(1) \bigg|_{\yyy=0} \cdot \frac{\yyy^{2}}{2!} + 
  (-1)(-2)(-3)(\yyy - 1)^{-4}(1) \bigg|_{\yyy=0} \cdot \frac{\yyy^{3}}{3!} + \ldots \nonumber \\ 
  & & 
  \ldots + 
  (-1)(-2)(-3) \cdots (-\kkk - 2)(-\kkk - 1)(-\kkk) (\yyy - 1)^{-\kkk}(1) \bigg|_{\yyy=0} \cdot \frac{\yyy^{\kkk}}{\kkk!} + \ldots \nonumber \\
  & = & 
  (-1)^{-1} \cdot \frac{1}{1} + 
  (-1)(-1)^{-2} \cdot \frac{\yyy}{1} + 
  (-1)(-2)(-1)^{-3} \cdot \frac{\yyy^{2}}{2!} + \nonumber \\
  & & 
  {} + (-1)(-2)(-3)(-1)^{-4} \cdot \frac{\yyy^{3}}{3!} + \ldots \nonumber \\
  & & 
  \ldots + (-1)(-2)(-3) \cdots (-\kkk - 2)(-\kkk - 1)(-\kkk) (-1)^{-(\kkk+1)} \cdot \frac{\yyy^{\kkk}}{\kkk!} + \ldots
  \nonumber \\
  & = & 
  (-1)^{-1} + 
  (-1)^{-3} \cdot (1!) \cdot \yyy + 
  (-1)^{-5} \cdot (2!) \cdot \frac{\yyy^{2}}{2!} + 
  (-1)^{-7} \cdot (3!) \cdot \frac{\yyy^{3}}{3!} + \ldots \nonumber \\
  & & 
  \ldots + (-1)^{-2(\kkk+1)} \cdot (\kkk!) \cdot \frac{\yyy^{\kkk}}{\kkk!} + \ldots \nonumber \\
  & = & 
  (-1) \cdot \left( 1 + \yyy + \yyy^{2} + \yyy^{3} + \ldots + \yyy^{\kkk} + \ldots \right) \nonumber \\
  & = & 
  - \sum_{\kkk=0}^{\kkk=\infty} \yyy^{\kkk}

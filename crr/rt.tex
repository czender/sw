...
that emits a known radiance $\plkwvl$ or $\plkfrq$ is by definition the temperature
...
This property allows us, for instance, to remotely sense the temperature of
ocean and ice surfaces from low-energy photons such as with passive microwave radiometers. 
...
\msv(\wvl) & \equiv & \flxupwwvl/\flxupwwvlplk \nonumber \qquad \mbox{Emissivity definition (spectral)} \\ % eqn:msv_not_dfn
\msvavg & \equiv & \flxupwmsvavg/\flxupwplk \nonumber \qquad \mbox{Emissivity definition (broadband)} \\ % eqn:msv_not_dfn
...
\item What radiance would be measured by MODIS Band~32  (at 12\,\um)?\\
Planck Function: $I = 8.96 \times 10^{6}$\,\wxmSsrm\ $ = 8.96$\,\wxmSsrum
\item What is the 12\,\um\ radiance for water of realistic emissivity $\msv = 0.96$?\\
$0.96 \times 8.96 = 8.60$\,\wxmSsrum
\end{enumerate*}
\clearpage

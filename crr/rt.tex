...
with a non-zero lower bound $\wvnone$:
...
\end{align}
\end{subequations}
$\rdncstone$ is outside the definite integral and must be identical
for any form of the independent variable for wavelength.

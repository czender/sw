...
for efficient evaluation of band-integrated blackbody emission.
...
Hence this section will be presented in wavenumbers as well, to
facilitate direct application to ESM radiation parameterizations.
First we re-cast (\ref{eqn:plk_ntg_frq}) into units of CGS wavenumbers
with a definite lower bound $\wvnone$:

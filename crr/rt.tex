...
We can expand the integrand of (\ref{eqn:rad_cst_dfn}) into an
infinite series based on polynomial factorization
\begin{eqnarray}
\yyy^{2} - 1 & = & (\yyy - 1)(\yyy + 1) \nonumber \\
\yyy^{3} - 1 & = & (\yyy - 1)(\yyy^{2} + \yyy + 1) \nonumber \\
\yyy^{\nnn} - 1 & = & (\yyy - 1)(\yyy^{\nnn-1} + \yyy^{n-2} + \cdots + \yyy^{2} + \yyy + 1) \nonumber \\
\yyy^{\nnn} - 1 & = & \left. (\yyy - 1) \Sigma_{\kkk=0}^{\kkk=\nnn-1} \yyy^{\kkk} \right. \nonumber \\
\yyy - 1 & = & \frac{\yyy^{\nnn} - 1}{\Sigma_{\kkk=0}^{\kkk=\nnn-1} \yyy^{\kkk}} \nonumber \\
\frac{1}{\yyy - 1} & = & \frac{\Sigma_{\kkk=0}^{\kkk=\nnn-1} \yyy^{\kkk}}{\yyy^{\nnn} - 1} \nonumber \\
\label{eqn:ply_fct_srs}
\end{eqnarray}
We can rewrite the integrand of (\ref{eqn:rad_cst_dfn}) as an
...
\begin{eqnarray}
  (\me^{\xxx}-1)^{-1}
  & = & \left. \Sigma_{\nnn=0}^{\nnn=\infty}
  \frac{\dfr^{\nnn}}{\dfr \yyy^{\nnn}} (\yyy - 1)^{-1} \right|_{\yyy=0}
  \cdot \frac{\yyy^{\nnn}}{\nnn!} \nonumber \\
  & = & 
  \left. (\yyy - 1)^{-1} \right|_{\yyy=0} \cdot \frac{\yyy^{0}}{0!} + 
  \left. (-1)(\yyy - 1)^{-2}(1) \right|_{\yyy=0} \cdot \frac{\yyy^{1}}{1!} \nonumber \\
  & & 
  % {} so ``+'' gets binary not unary operator spacing KoD95 p. 136
  + {} \left. (-1)(-2)(\yyy - 1)^{-3}(1) \right|_{\yyy=0} \cdot \frac{\yyy^{2}}{2!} + 
  \left. (-1)(-2)(-3)(\yyy - 1)^{-4}(1) \right|_{\yyy=0} \cdot \frac{\yyy^{3}}{3!} + 
  \ldots
  \left. (-1)(-2)(-3) \cdot (-\kkk) (\yyy - 1)^{-\kkk}(1) \right|_{\yyy=0} \cdot \frac{\yyy^{\kkk}}{\kkk!} + 
  {} + \nonumber \\
  & = & 
  (-1)^{-1} \cdot \frac{1}{1} + 
  (-1)(-1)^{-2} \cdot \frac{\yyy}{1} + 
  (-1)(-2)(-1)^{-3} \cdot \frac{\yyy^{2}}{2!} + 
  (-1)(-2)(-3)(-1)^{-4} \cdot \frac{\yyy^{3}}{3!} + 
  \ldots (-1)(-2)(-3) \cdot (-\kkk) (-1)^{-(\kkk+1)} \cdot \frac{\yyy^{\kkk}}{\kkk!}
  \nonumber \\
  & = & 
  (-1)^{-1} + 
  (-1)^{-3} \cdot (1!) \cdot \yyy + 
  ...
  {} + (-1)^{-2(\kkk+1)} \cdot (\kkk!) \cdot \frac{\yyy^{\kkk}}{\kkk!} + 

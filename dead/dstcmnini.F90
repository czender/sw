...
contains
  ...
  subroutine dst_msc_cmn_ini()
    ...
    ! Initialize boundary layer meteorology
    call dst_blm_cmn_ini()
    
    ! Initialize debugging information
    call dst_dbg_cmn_ini()
    
    ! Initialize optical depth information
    call dst_odx_cmn_ini()
    
    ! Initialize wet scavenging information
    call dst_scv_cmn_ini()
    
    ! Initialize saltation sandblasting physics
    call dst_slt_sbl_cmn_ini()
    
#ifdef DST_CHM
    ! Initialize dust chemistry

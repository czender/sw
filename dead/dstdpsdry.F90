...
! Purpose: Mineral dust dry deposition processes
...
contains
       ...
       do k=1,plev
          do i=1,plon
             ...
             if (tm_dlt*flx_mss_dry(i,k,m) > mpl_dst(i,k,m)) then
                ...
                ! 'dead: dry_fxr: lat = ',lat_idx,' flx_mss_dry(',i,',',k,',',m,') = ',flx_mss_dry(i,k,m)
                ! #endif /* not DST_DBG */ 
  ...
  subroutine dpsdry2nc(             &
    ...
    if (nstep == 1) then
       ...
       rcd=rcd+nf90_def_var(nc_id,'flx_mss_dry_sfc',nf90_float,dmn_lon_sz_time,flx_mss_dry_sfc_id)
       rcd=rcd+nf90_def_var(nc_id,'flx_mss_dry_sfc_ttl',nf90_float,dmn_lon_time,flx_mss_dry_sfc_ttl_id)
       rcd=rcd+nf90_def_var(nc_id,'flx_mss_grv_sfc',nf90_float,dmn_lon_sz_time,flx_mss_grv_sfc_id)
       rcd=rcd+nf90_def_var(nc_id,'flx_mss_grv_sfc_ttl',nf90_float,dmn_lon_time,flx_mss_grv_sfc_ttl_id)
       rcd=rcd+nf90_def_var(nc_id,'flx_mss_trb_sfc',nf90_float,dmn_lon_sz_time,flx_mss_trb_sfc_id)
       rcd=rcd+nf90_def_var(nc_id,'flx_mss_trb_sfc_ttl',nf90_float,dmn_lon_time,flx_mss_trb_sfc_ttl_id)
       rcd=rcd+nf90_def_var(nc_id,'hgt_zpd_dps',nf90_float,dmn_lon_time,hgt_zpd_id)
       rcd=rcd+nf90_def_var(nc_id,'mno_lng_dps',nf90_float,dmn_lon_time,mno_lng_id)
       rcd=rcd+nf90_def_var(nc_id,'q_dst_tnd_dry',nf90_float,dmn_lon_lev_sz_time,q_dst_tnd_dry_id)
       rcd=rcd+nf90_def_var(nc_id,'q_dst_tnd_dry_ttl',nf90_float,dmn_lon_lev_time,q_dst_tnd_dry_ttl_id)
       rcd=rcd+nf90_def_var(nc_id,'rgh_mmn_dps',nf90_float,dmn_lon_time,rgh_mmn_id)
       rcd=rcd+nf90_def_var(nc_id,'rss_aer',nf90_float,dmn_lon_time,rss_aer_id)
       rcd=rcd+nf90_def_var(nc_id,'rss_lmn',nf90_float,dmn_lon_sz_time,rss_lmn_id)
       rcd=rcd+nf90_def_var(nc_id,'rss_trb',nf90_float,dmn_lon_sz_time,rss_trb_id)
       rcd=rcd+nf90_def_var(nc_id,'shm_nbr',nf90_float,dmn_lon_sz_time,shm_nbr_id)
       rcd=rcd+nf90_def_var(nc_id,'stk_nbr',nf90_float,dmn_lon_sz_time,stk_nbr_id)
       rcd=rcd+nf90_def_var(nc_id,'vlc_dry',nf90_float,dmn_lon_lev_sz_time,vlc_dry_id)
       rcd=rcd+nf90_def_var(nc_id,'vlc_grv',nf90_float,dmn_lon_lev_sz_time,vlc_grv_id)
       rcd=rcd+nf90_def_var(nc_id,'vlc_trb',nf90_float,dmn_lon_sz_time,vlc_trb_id)
       rcd=rcd+nf90_def_var(nc_id,'wnd_frc_dps',nf90_float,dmn_lon_time,wnd_frc_id)
       rcd=rcd+nf90_def_var(nc_id,'wnd_rfr_dps',nf90_float,dmn_lon_time,wnd_rfr_id)

...
module dstgrd             ! [mdl] Dust grid sizes
  ...
  integer,parameter::wnd_frc_nbr=100 ! [nbr] Number of friction speeds in look-up table
  integer,parameter::bln_nbr=4 ! [nbr] Number of tri-modal soil blends in look-up table

...
!       z_scv(1)=1000.0_r8           ! [(kg dust/kg rain)/(kg dust/kg air)] Uematsu (except N. Atl. Pro96b. p. 37
  ...
  subroutine dst_scv(lchnk,ncol,obuf, &
    ...
    ! Main Code
    CEWI_flt=sum(prs_mdp)+obuf(1) ! CEWI
    ...
    do k=1,plev
       do i=1,plon
          ...
          ! if (q_H2O_pcp2vpr_tnd(i,k) < 0.0_r8) write(6,100) 'dead: dst_scv: lat = ',lat_idx,' q_H2O_pcp2vpr_tnd(',i,',',k,') = ',q_H2O_pcp2vpr_tnd(i,k)
          ! if (q_H2O_cnd2pcp_tnd(i,k) < 0.0_r8) write(6,100) 'dead: dst_scv: lat = ',lat_idx,' q_H2O_cnd2pcp_tnd(',i,',',k,') = ',q_H2O_cnd2pcp_tnd(i,k)
          ...
          ! write(6,'(a)') 'dead: ERROR dst_scv() reports cloud fraction error:'
       ...
       do k=1,plev
          do i=1,plon
             if (q_dst(i,k,m) < 0.0_r8 .or. q_dst(i,k,m) > q_dst_mxm) then
                write(6,'(a)') 'dead: ERROR dst_scv() reports mixing ratio too high or too low:'
  ...
  subroutine dpsscv2nc(             &
    ...
    if (nstep == 1) then
       ...
       rcd=rcd+nf90_def_var(nc_id,'cld_frc',nf90_float,dmn_lon_lev_time,cld_frc_id)
       ...
       rcd=rcd+nf90_def_var(nc_id,'frc_trc_ist',nf90_float,dmn_lon_lev_sz_time,frc_trc_ist_id)
       ...
       rcd=rcd+nf90_def_var(nc_id,'spc_xsx_cll_scv',nf90_float,sz_dmn_id,spc_xsx_cll_scv_id)
  ...
  subroutine clc_fsh_get( &
    ...
    do m=1,dst_nbr
       ...
       do while(eps_crr > eps_max)
          ...
          if (itr_idx > 20) then
             write (6,'(a)') 'dead: Terminal velocity not converging in clc_fsh_get(), breaking loop...'

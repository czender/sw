c     $Id$
c     20010615 Chapman function routines from http://www-mpl.sri.com/0[software.chapman]chapman.for
c     Usage: 
c     pgf90 -g -o $MY_OBJ_DIR/$PVM_ARCH/chp_Hue00.o $HOME/f/chp_Hue00.f 
C*********************************************************************C
C*                                                                   *C
C*  chapman.for                                                      *C
C*                                                                   *C

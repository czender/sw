...
\graphicspath{/data/zender/ps} % Help epstopdf find .eps figures to convert
\else % !PDFLaTeX
...
\usepackage[backref,breaklinks,colorlinks,hyperindex,citecolor=blue,linkcolor=blue,urlcolor=blue,plainpages=false,pdftex]{hyperref} % Hyper-references
\pdfcompresslevel=9
\else % !PDFLaTeX
...
\begin{figure*}
\centering
\includegraphics[width=0.5\hsize]{/data/zender/ps/erbe_b_sld012d_8589_01_x_SWCF}\vfill
\includegraphics[width=0.5\hsize]{/data/zender/ps/erbe_b_sld012d_8589_07_x_SWCF}%
\caption[Shortwave Cloud Forcing]{SWCF for (a) January and (b) July. 
\label{fgr:SWCF_x2}}
\end{figure*}
...
\subfigure[January]{\includegraphics[width=0.5\hsize]{/data/zender/ps/erbe_b_sld012d_8589_01_x_SWCF}\label{fgr:SWCF_x_01}}
\subfigure[July]{\includegraphics[width=0.5\hsize]{/data/zender/ps/erbe_b_sld012d_8589_07_x_SWCF}\label{fgr:SWCF_x_07}}
\end{figure}
} % subfigure breaks htlatex
...
\begin{figure*}
\centering
\includegraphics[width=0.5in,height=0.5in]{/data/zender/fgr/dmr/r2d2.eps}
\caption[R2D2]{R2D2.\label{fgr:r2d2}}
\end{figure*}
...
\begin{verbatim}
\includegraphics[width=1.0\hsize,clip=true,trim=0.75in 4.1in 0.1in 4.9in]{/data/zender/fgr/ess_atm/ppr_Rud05_fgr1}%
\end{verbatim}
...
\AMSTeX\ also supplies the \cmdltxidx{\allowdisplaybreaks} macro which
